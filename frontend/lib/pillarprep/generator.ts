...
export function generateBlueMesaBackupBrief(
  ...
  const defaults: BriefRequest = {
    ...
    additionalDirection: "Treat BlueMesa as an existing AWS customer. Make payroll integration, mixed API and encrypted-file interfaces, idempotency, reconciliation, data privacy, retention, partner certification, cutover, and recovery evidence explicit. Ledger replacement is out of scope.",
    decisionMakers: [
    ...
    meetingNotes: "BlueMesa approved a bounded payroll-partner pilot. Dev owns interface and recovery evidence, Rachel owns payroll-data controls, Priya owns reconciliation operations, Elena owns partner coordination, and Ariana is the executive gate. No partner traffic moves until replay, rollback, and data-handling evidence are accepted.",
