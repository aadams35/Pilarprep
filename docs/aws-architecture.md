...
```mermaid
flowchart TD
  A[React front end] --> B[API Gateway]
...
1. The user enters company, industry, meeting type, size, pillars, and context.
...
7. Approved briefs and meeting notes become grounding material for Project Brain.
8. Strands becomes the optional Phase 2 agent layer for tool-using follow-up.
